...
rd  SystemApps
cd System32 
del DevicePairing.dll
del DevicePairingExperienceMEM.dll
del DevicePairingFolder.dll
del DevicePairingProxy.dll
del DevicePairingWizard.exe
del DeviceProperties.exe
del DeviceReactivation.dll
del deviceregistration.dll
del DeviceSetupManager.dll
del DeviceSetupManagerAPI.dll
del DeviceSetupStatusProvider.dll
del DevicesFlowBroker.dll
